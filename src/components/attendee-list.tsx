                ...
                <thead>
                    <tr className='border-b border-white/10'>
                        <TableHeader style={{ width: 48 }} className='py-3 px-4 text-sm font-semibold text-left'>
                            <input type="checkbox" className='size-4 bg-black/20 rounded border border-white/10 checked:text-orange-500' />
                        </TableHeader>
                        ...
                        <TableRow key={i}>
                            ...
                            <TableCell>
                                <div className='flex flex-col gap-1'>
                                    <span className='font-semibold text-white'>Nathan Ferreira</span>
                                    <span>nathan.ferreiira@gmail.com</span>
                                </div>
                            </TableCell>
